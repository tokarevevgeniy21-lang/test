...
// Поиск и фильтры - гарантируем строковые значения
$search = isset($_GET['search']) ? (string)$_GET['search'] : '';
$sourceFilter = isset($_GET['source']) ? (string)$_GET['source'] : '';
$ageGroupFilter = isset($_GET['age_group']) ? (string)$_GET['age_group'] : '';
                ...
                <form method="GET" class="row g-3 mb-4">
                    ...
                    <div class="col-md-2">
                        <select class="form-select" name="source">
                            ...
                            <option value="<?= htmlspecialchars((string)$source['id']) ?>" <?= $sourceFilter == $source['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-2">
                        <select class="form-select" name="age_group">
                            ...
                            <option value="<?= htmlspecialchars((string)$group['id']) ?>" <?= $ageGroupFilter == $group['id'] ? 'selected' : '' ?>>
