...
// Получаем список возрастных групп
$ageGroups = CRUDController::getList($tableConfig['table'], 'is_active = 1', [], 'min_age ASC');
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="max_age" min="0">
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.edit-item').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            form.querySelector('[name="min_age"]').value = item.min_age;
            form.querySelector('[name="max_age"]').value = item.max_age;
